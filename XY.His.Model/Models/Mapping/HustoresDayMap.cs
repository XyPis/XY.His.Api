...
{
    public class HustoresDayMap : EntityTypeConfiguration<HustoresDay>
    {
        public HustoresDayMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.StockTime, t.StockID, t.HouseId, t.ItemId, t.unitid, t.StockPrice, t.RetailPrice, t.StockNum, t.IsBid, t.IsInject, t.OptionPrice, t.IsSpecSum, t.IsAntiBacterial });
