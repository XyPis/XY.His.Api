...
namespace XY.His.Model.Models.Mapping
{
    public class InHosInfoMap : EntityTypeConfiguration<InHosInfo>
    {
        public InHosInfoMap()
        {
            ...
            // Relationships
            this.HasOptional(t => t.BsBed)
                .WithMany(t => t.InHosInfoes)
                .HasForeignKey(d => d.BedId);
            this.HasOptional(t => t.BsCertificate)
                .WithMany(t => t.InHosInfoes)
            ...
            this.HasOptional(t => t.BsDoctor1)
                .WithMany(t => t.InHosInfoes1)
                .HasForeignKey(d => d.DocMz);
            this.HasOptional(t => t.BsFromHospital)
                .WithMany(t => t.InHosInfoes)
                .HasForeignKey(d => d.FromHospitalId);
            this.HasRequired(t => t.BsLocation)
                .WithMany(t => t.InHosInfoes)
                .HasForeignKey(d => d.LocIn);
            this.HasOptional(t => t.BsLocation1)
                .WithMany(t => t.InHosInfoes1)
                .HasForeignKey(d => d.LocationId);
            this.HasOptional(t => t.BsLocation2)
                .WithMany(t => t.InHosInfoes2)
                .HasForeignKey(d => d.LocOut);
            ...
            this.HasOptional(t => t.BsRelation)
                .WithMany(t => t.InHosInfoes)
                .HasForeignKey(d => d.RelationId);
            this.HasOptional(t => t.BsWorkType)
                .WithMany(t => t.InHosInfoes)
                .HasForeignKey(d => d.WorktypeId);
            this.HasOptional(t => t.InHosInfo2)
                .WithMany(t => t.InHosInfo1)
                .HasForeignKey(d => d.MotherHospId);
